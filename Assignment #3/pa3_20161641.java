...
public class pa3_20161641 extends Frame implements ActionListener{
	Frame f;	//Main Frame
	...
	public pa3_20161641(){		//constructor
		f = new Frame("20161641 Calculator");
		f.setLayout(new BorderLayout(6,5));		//make BorderLayout
		f.setSize(300, 450);	//set Calculator Size
		f.setBackground(new Color(50,50,50));	//set Calculator Background color
		f.setResizable(false);		//prevent resize
		...
		f.add(p[0],"North");
		f.add(p[1],"Center");
		WindowDestroyer listener = new WindowDestroyer();		// add WindowDestroyer
		f.addWindowListener(listener);
		f.setVisible(true);		//set Calculator visible
	}
	...
	public static void main(String[] args){
		pa3_20161641 frm = new pa3_20161641();
	}
}
